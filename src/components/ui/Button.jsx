...
function Button({
  ...
  const baseStyles =
    "font-medium py-2 px-4 rounded-sm focus:outline-none focus:ring-2 transition-all duration-300";
  const solidStyles =
    "bg-[#1f36c7] text-white hover:bg-blue-700 focus:ring-[#1f36c7] disabled:bg-blue-300 disabled:cursor-not-allowed";
  const outlineStyles =
